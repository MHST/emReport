    ...
    <table class="tab1">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <input class="txt" value="{DATA.khoa}" name="khoa" id="khoa_iavim" style="width:300px" />
                </td>
            </tr>
        </tbody>
        <tbody class="second">
            <tr>
                ...
                <td>
                    <input class="txt" value="{DATA.trinhdo}" name="trinhdo" id="trinhdo_iavim" style="width:300px" />
                </td>
            </tr>
        </tbody>
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <img src="{NV_BASE_SITEURL}images/calendar.jpg" style="cursor: pointer; vertical-align: middle;" onclick="popCalendar.show(this, 'ngaycapbang', 'dd.mm.yyyy', true);" alt="" height="17" />
                </td>
            </tr>
        </tbody>
        <tbody class="second">
            <tr>
                ...
                <td>
                    <input class="txt" value="{DATA.mabenhvien}" name="mabenhvien" id="mabenhvien_iavim" style="width:300px" />
                </td>
            </tr>
        </tbody>
        <tbody>
        ...
        <tbody>
            <tr>
                <td colspan="3">
                    <input type="submit" name="confirm" value="{LANG.doctor_add}" />
                </td>
            </tr>
        </tbody>
    </table>
