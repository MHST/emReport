			...
			<div class="widget-content widget-content-boxsearch">
				...
				<div class="shortcuts">
					...
					<form class="form-horizontal" action="{ACTION}" method="post">
						<input type="text" class="span3 search-emreport" name="cmnd" placeholder="Nhập số CMND"><br>
						<input class="btn btn-large btn-primary" type="submit" value="Tạo sổ">
						<input class="btn btn-large btn-danger" type="reset" value="Hủy">
